...
public class CurriculumSubjects implements Serializable {
	...
	private int ethic = 0;
	private int lithuanian_A = 0;
	private int lithuanian_B = 0;
	private int native_Russian = 0;
	private int native_Polish = 0;
	private int history = 0;
	private int geography = 0;
	private int social = 0;
	private int foreign_English = 0;
	private int foreign_German = 0;
	private int foreign_French = 0;
	private int foreign_Russian = 0;
	private int mathematics = 0;
	private int biology = 0;
	private int physics = 0;
	private int chemistry = 0;
	private int natural_Sciences = 0;
	private int physical_Education = 0;
	private int football = 0;
	private int basketball = 0;
	private int russian_II = 0;
	private int english_II = 0;
	private int german_II = 0;
	private int design = 0;
	private int art = 0;
	private int theater = 0;
	private int music = 0;
	private int information_Technology = 0;
	private int advanced_Lithuanian_Native = 0;
	private int advanced_Lithuanian_State = 0;
	private int advanced_Foreign_Language = 0;
	private int advanced_History = 0;
	private int advanced_Mathematics = 0;
	private int advanced_Biology = 0;
	private int advanced_Physics = 0;
	private int advanced_Chemistry = 0;
	private int chemistry_Module = 0;
	private int biology_Module_I = 0;
	private int biology_Module_II = 0;
	private int physics_Module_I = 0;
	private int physics_Module_II = 0;
	private int physics_Module_III = 0;
